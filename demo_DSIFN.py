...
def get_args():
    ...
    parser.add_argument('--project_name', default='MATNet_DSIFN', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='/home/zzy/project/MATNet/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_DSIFN/predict_MATNet', type=str)
    ...
    parser.add_argument('--net_G', default='MATNet', type=str,
                        help='MATNet | CD_SiamUnet_diff | SiamUnet_conc | Unet | DTCDSCN | base_resnet18 | base_transformer_pos_s4_dd8 | base_transformer_pos_s4_dd8_dedim8|')

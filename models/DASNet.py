...
def cnn():
    model = DANet(256, backbone='resnet50')
    return model
...
class UperNet(nn.Module):
    def __init__(self, norm_flag='l2'):
        ...
        self.classifier = nn.Sequential(
            nn.Conv2d(256 * 3, 256, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm2d(256),
    ...
    def forward(self, t0, t1):
        ...
        out_t0_embedding_norm, out_t1_embedding_norm = self.norm(out_t0_embedding, 2, dim=1), self.norm(
            out_t1_embedding, 2, dim=1)
